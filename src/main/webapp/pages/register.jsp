    ...
    <form action="<%=basePath %>/register.shtml" method="post">
      <div class="form-group has-feedback">
        ...
        <sapn style="display: block;margin-bottom: -30px">企业名称： </sapn>
              <input type="text" class="form-control" style="width: 270px;margin-left: 85px"  placeholder="请输入企业名称" name="corpname">
      ...
      <div class="form-group has-feedback" style="margin-top: 30px">
        ...
        <sapn style="display: block;margin-bottom: -30px">联系人姓名： </sapn>
             <input type="text" class="form-control" style="width: 270px;margin-left: 85px" placeholder="请输入联系人姓名" name="name">
        <span style="display: block;margin-top: -30px;margin-left: 320px">
      ...
      <div class="form-group has-feedback" style="margin-top: 30px">
        ...
        <sapn style="display: block;margin-bottom: -30px">联系人职务： </sapn>
            <input type="text" class="form-control" style="width: 270px;margin-left: 85px" placeholder="请输入联系人职务" name="job">
        <span style="display: block;margin-top: -30px;margin-left: 320px">
      ...
      <div class="form-group has-feedback" style="margin-top: 30px">
        <sapn style="display: block;margin-bottom: -30px">邮箱地址： </sapn>
            <input type="email" class="form-control" style="width: 270px;margin-left: 85px" placeholder="请输入邮箱地址" name="email">
        <span style="display: block;margin-top: -30px;margin-left: 320px">

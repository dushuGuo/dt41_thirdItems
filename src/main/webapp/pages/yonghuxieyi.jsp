  ...
  <div class="content-wrapper">
    <div class="container">
      ...
      <section class="content-header">
        <center><h1>用户协议</h1></center>
        <ol class="breadcrumb">
          <li><a href="#"><i class="fa fa-dashboard"></i> 注册</a></li>
          
          <li class="active">用户注册协议</li>
        </ol>
      </section>
      ...
      <section class="content">
        ...
        <div class="box box-default">
          <div class="box-header with-border">
            <h3 class="box-title">一、总则</h3>
          </div>
          <div class="box-body">
            <p>1.1 数据驾驶舱的所有权和运营权归智动天下科技有限公司所有。</p>
            <p>1.2 用户在注册之前，应当仔细阅读本协议，并同意遵守本协议后方可成为注册用户。一旦注册成功，则用户与数据驾驶舱之间自动形成协议关系，用户应当受本协议的约束。用户在使用特殊的服务或产品时，应当同意接受相关协议后方能使用。</p>
            <p>1.3 本协议则可由数据驾驶舱随时更新，用户应当及时关注并同意本站不承担通知义务。本站的通知、公告、声明或其它类似内容是本协议的一部分</p>
          </div>
          <div class="box-header with-border">
            <h3 class="box-title">二、服务内容</h3>
          </div>
           <div class="box-body">
            <p>2.1 数据驾驶舱的具体内容由本站根据实际情况提供。</p>
            <p>2.2 本站仅提供相关的网络服务，除此之外与相关网络服务有关的设备(如个人电脑、手机、及其他与接入互联网或移动网有关的装置)及所需的费用(如为接入互联网而支付的电话费及上网费、为使用移动网而支付的手机费)均应由用户自行负担。</p>
          </div>
            <div class="box-header with-border">
            <h3 class="box-title">三、用户帐号</h3>
          </div>
           <div class="box-body">
           <p>3.1 经本站注册系统完成注册程序并通过身份认证的用户即成为正式用户，可以获得本站规定用户所应享有的一切权限；未经认证仅享有本站规定的部分会员权限。数据驾驶舱有权对会员的权限设计进行变更。</p>
           ...
           <div class="box-body">
            ...
            <p>&emsp;&emsp;(1)违反宪法确定的基本原则的；</p>
            <p>&emsp;&emsp;(2)危害国家安全，泄漏国家机密，颠覆国家政权，破坏国家统一的；</p>
            ...
            <p>&emsp;&emsp;(7)散布淫秽、色情、赌博、暴力、恐怖或者教唆犯罪的；</p>
            <p>&emsp;&emsp;(8)侮辱或者诽谤他人，侵害他人合法权益的；</p>
            <p>&emsp;&emsp;(9)煽动非法集会、结社、游行、示威、聚众扰乱社会秩序的；</p>
            <p>&emsp;&emsp;(10)以非法民间组织名义活动的；</p>
            <p>&emsp;&emsp;(11)含有法律、行政法规禁止的其他内容的。</p>
            ...
            <p>&emsp;&emsp;(1)不得为任何非法目的而使用网络服务系统；</p>
            <p>&emsp;&emsp;(2)遵守所有与网络服务有关的网络协议、规定和程序；</p> 
            <p>&emsp;&emsp;(3)不得利用本站进行任何可能对互联网的正常运转造成不利影响的行为；</p>
            <p>&emsp;&emsp;(4)不得利用本站进行任何不利于本站的行为。</p> 
            <p>4.5 如用户在使用网络服务时违反上述任何规定，本站有权要求用户改正或直接采取一切必要的措施(包括但不限于删除用户张贴的内容、暂停或终止用户使用网络服务的权利)以减轻用户不当行为而造成的影响。</p> 
          </div>
            <div class="box-header with-border">
            <h3 class="box-title">五、隐私保护</h3>
          </div>
           <div class="box-body">
            <p>5.1 本站不对外公开或向第三方提供单个用户的注册资料及用户在使用网络服务时存储在本站的非公开内容，但下列情况除外：</p> 
            <p>&emsp;&emsp;(1)事先获得用户的明确授权；</p>
            <p>&emsp;&emsp;(2)根据有关的法律法规要求；</p>
            <p>&emsp;&emsp;(3)按照相关政府主管部门的要求；</p>
            <p>&emsp;&emsp;(4)为维护社会公众的利益。</p>
            ...
            <div class="box-header with-border">
            <h3 class="box-title">六、版权声明</h3>
          </div>
           <div class="box-body">
           <p>6.1 本站的文字、图片、音频、视频等版权均归智动天下科技有限公司享有或与作者共同享有，未经本站许可，不得任意转载。</p>
           <p>6.2 本站特有的标识、版面设计、编排方式等版权均属智动天下科技有限公司享有，未经本站许可，不得任意复制或转载。</p>
           <p>6.3 使用本站的任何内容均应注明“来源于数据驾驶舱”及署上作者姓名，按法律规定需要支付稿酬的，应当通知本站及作者及支付稿酬，并独立承担一切法律责任。</p>
           ...
           <p>6.6 恶意转载本站内容的，本站保留将其诉诸法律的权利。</p>
            ...
            <div class="box-header with-border">
            <h3 class="box-title">七、责任声明</h3>
          </div>
           <div class="box-body">
            <p>7.1 用户明确同意其使用本站网络服务所存在的风险及一切后果将完全由用户本人承担，数据驾驶舱对此不承担任何责任。</p>
            ...
            <p>&emsp;&emsp;(1)本站向用户免费提供的各项网络服务；</p>
            <p>&emsp;&emsp;(2)本站向用户赠送的任何产品或者服务。</p>
            <p>7.6 本站有权于任何时间暂时或永久修改或终止本服务(或其任何部分)，而无论其通知与否，本站对用户和任何第三人均无需承担任何责任。</p>
          </div>
            <div class="box-header with-border">
            <h3 class="box-title">八、附则</h3>
          </div>
           <div class="box-body">
            <p>8.1 本协议的订立、执行和解释及争议的解决均应适用中华人民共和国法律。</p>
            <p>8.2 如本协议中的任何条款无论因何种原因完全或部分无效或不具有执行力，本协议的其余条款仍应有效并且有约束力。</p>
            <p>8.3 本协议解释权及修订权归智动天下科技有限公司所有。</p>
          </div>
          <center>
          <div>
            <a href="<%=basePath %>/pages/register.jsp" style="color:#FFF">
             <button type="button" class="btn bg-olive margin" >返回注册</button>
             </a>
          </div>
          </center>
